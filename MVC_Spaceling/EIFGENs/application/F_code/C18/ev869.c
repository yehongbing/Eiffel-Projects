...
void F1176_16524 (EIF_REFERENCE Current)
{
	GTCX
	EIF_POINTER tp1;
	RTLD;
...
void F1176_16525 (EIF_REFERENCE Current)
{
	GTCX
	EIF_POINTER tp1;
	RTLD;
...
EIF_BOOLEAN F1176_16526 (EIF_REFERENCE Current)
{
	GTCX
	EIF_POINTER tp1;
...
void F1176_16527 (EIF_REFERENCE Current)
{
	GTCX
	EIF_POINTER tp1;
	RTLD;
	...
	RTGC;
	if ((EIF_BOOLEAN) !F1176_16526(Current)) {
...
void F1176_16528 (EIF_REFERENCE Current)
{
	GTCX
	EIF_POINTER tp1;
	RTLD;
...
EIF_BOOLEAN F1176_16529 (EIF_REFERENCE Current)
{
	GTCX
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
	...
	RTGC;
	Result = '\0';
	if ((EIF_BOOLEAN)(F1165_16458(Current) != NULL)) {
		Result = (EIF_BOOLEAN) !*(EIF_BOOLEAN *)(Current+ _CHROFF_22_4_);
	}
	RTLE;
	return Result;
}
...
static EIF_REFERENCE F1176_16531_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F1176_16531 (EIF_REFERENCE Current)
{
	EIF_REFERENCE r;

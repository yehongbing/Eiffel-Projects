...
void F1189_16722 (EIF_REFERENCE Current)
{
	GTCX
	...
	
	{
		...
		typres0 = (typcache0 != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRF(typres0, (EIF_POINTER) __A412_334, (EIF_POINTER) _A412_334, (EIF_POINTER)(F790_8083),tr2, 1, 0);
	}
	...
	
	{
		...
		typres0 = (typcache0 != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3 = RTLNRF(typres0, (EIF_POINTER) __A412_335, (EIF_POINTER) _A412_335, (EIF_POINTER)(F790_8084),tr2, 1, 0);
	}
	F1079_14139(Current, loc2, tr1, tr3, NULL);
	F1188_16714(Current);
	tr1 = F775_7089(RTCV(RTOSCF(14148,F1079_14148,(Current))));
	F1189_16725(Current, tr1);
	F1029_13080(Current, (EIF_BOOLEAN) 1);
	RTLE;
}

/* {EV_DIRECTORY_DIALOG_IMP}.start_path */
EIF_REFERENCE F1189_16724 (EIF_REFERENCE Current)
{
...
void F1189_16725 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	*(EIF_REFERENCE *)(Current + _REFACS_7_) = (EIF_REFERENCE) arg1;
	...
	inline_F31_1190(tp1, tp2);
	RTLE;
}

/* {EV_DIRECTORY_DIALOG_IMP}.interface */
static EIF_REFERENCE F1189_16726_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F1189_16726 (EIF_REFERENCE Current)
{
	EIF_REFERENCE r;

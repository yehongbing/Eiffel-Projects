...
/* {LINEAR}.has */
EIF_BOOLEAN F274_4465 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	Result = (FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R4175[dtype-273])(Current);
...
/* {LINEAR}.index_of */
EIF_INTEGER_32 F274_4466 (EIF_REFERENCE Current, EIF_REFERENCE arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	...
	if ((EIF_BOOLEAN) (*(EIF_BOOLEAN *)(Current + O4154[dtype-243]) && (EIF_BOOLEAN)(arg1 != NULL))) {
		...
		for (;;) {
			tb1 = '\01';
			if (!(FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R4175[dtype-273])(Current)) {
				tb1 = (EIF_BOOLEAN)(loc1 == arg2);
			}
			if (tb1) break;
			if (RTEQ((FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R4160[dtype-303])(Current), arg1)) {
				loc1++;
			}
		...
		for (;;) {
			...
			if (tb2) break;
			if (RTCEQ((FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R4160[dtype-303])(Current), arg1)) {
				loc1++;
			}
			(FUNCTION_CAST(void, (EIF_REFERENCE)) R4178[dtype-303])(Current);
			loc2++;
...
/* {LINEAR}.search */
void F274_4467 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	EIF_BOOLEAN tb1;
	EIF_BOOLEAN tb2;
	...
	if (*(EIF_BOOLEAN *)(Current + O4154[dtype-243])) {
		for (;;) {
			tb1 = '\01';
			if (!(FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R4175[dtype-273])(Current)) {
				tb1 = RTEQ(arg1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R4160[dtype-303])(Current));
			}
			if (tb1) break;
			(FUNCTION_CAST(void, (EIF_REFERENCE)) R4178[dtype-303])(Current);
		}
		...
		for (;;) {
			tb2 = '\01';
			if (!(FUNCTION_CAST(EIF_BOOLEAN, (EIF_REFERENCE)) R4175[dtype-273])(Current)) {
				tb2 = RTCEQ(arg1, (FUNCTION_CAST(EIF_REFERENCE, (EIF_REFERENCE)) R4160[dtype-303])(Current));
			}
			if (tb2) break;
			(FUNCTION_CAST(void, (EIF_REFERENCE)) R4178[dtype-303])(Current);
		}
...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F274_4471 (EIF_REFERENCE Current)
{
	GTCX
...
/* {LINEAR}.off */
EIF_BOOLEAN F274_4473 (EIF_REFERENCE Current)
{
	GTCX
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
...
EIF_REFERENCE F274_4480 (EIF_REFERENCE Current)
{
	GTCX

...
/* {LINEAR}.has */
EIF_BOOLEAN F275_4465 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1)
{
	GTCX
...
/* {LINEAR}.index_of */
EIF_INTEGER_32 F275_4466 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	...
	if ((EIF_BOOLEAN) (*(EIF_BOOLEAN *)(Current + O4154[dtype-243]) && EIF_TRUE)) {
		...
		for (;;) {
			tb1 = '\01';
			if (!F275_4471(Current)) {
				tb1 = (EIF_BOOLEAN)(loc1 == arg2);
			}
			if (tb1) break;
			if ((F702_6583(Current) == arg1)) {
				loc1++;
			}
			F702_6611(Current);
			loc2++;
		...
		for (;;) {
			...
			if (tb2) break;
			if ((EIF_BOOLEAN)(F702_6583(Current) == arg1)) {
				loc1++;
			}
			F702_6611(Current);
			loc2++;
...
/* {LINEAR}.search */
void F275_4467 (EIF_REFERENCE Current, EIF_INTEGER_8 arg1)
{
	GTCX
	EIF_BOOLEAN tb1;
	EIF_BOOLEAN tb2;
	...
	if (*(EIF_BOOLEAN *)(Current + O4154[Dtype(Current)-243])) {
		...
		for (;;) {
			tb2 = '\01';
			if (!F275_4471(Current)) {
				tb2 = (EIF_BOOLEAN)(arg1 == F702_6583(Current));
			}
			if (tb2) break;
			F702_6611(Current);
		}
...
/* {LINEAR}.exhausted */
EIF_BOOLEAN F275_4471 (EIF_REFERENCE Current)
{
	GTCX
...
/* {LINEAR}.off */
EIF_BOOLEAN F275_4473 (EIF_REFERENCE Current)
{
	GTCX
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);
...
EIF_REFERENCE F275_4480 (EIF_REFERENCE Current)
{
	GTCX

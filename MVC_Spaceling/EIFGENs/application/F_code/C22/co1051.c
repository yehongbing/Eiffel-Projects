...
/* {COLLECTION}.fill */
void F307_4517 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	for (;;) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R4201[dtype-404])(Current, (EIF_REFERENCE) &tu1_1);
		F703_6611(RTCV(loc1));
	}
	RTLE;
}
...
void F307_4519 (EIF_REFERENCE Current, EIF_NATURAL_8 arg1)
{
	GTCX
	RTCDT;
	RTLD;

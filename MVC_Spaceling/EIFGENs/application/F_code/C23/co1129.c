...
/* {COLLECTION}.fill */
void F310_4517 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	for (;;) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R4201[dtype-404])(Current, (EIF_REFERENCE) &tp1);
		F705_6611(RTCV(loc1));
	}
	RTLE;
}
...
void F310_4519 (EIF_REFERENCE Current, EIF_POINTER arg1)
{
	GTCX
	RTCDT;
	RTLD;

...
/* {COLLECTION}.fill */
void F313_4517 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	for (;;) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R4201[dtype-404])(Current, (EIF_REFERENCE) &tc1);
...
void F313_4519 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1)
{
	GTCX
	RTCDT;
	RTLD;

...
/* {LIST}.is_equal */
EIF_BOOLEAN F622_5835 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		if ((EIF_BOOLEAN)(F414_5127(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F708_6600(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
			tb1 = (EIF_BOOLEAN) !F414_5127(Current);
		}
		if (tb1) {
			tb1 = '\0';
			tr1 = F708_6589(Current);
			loc1 = tr1;
			if (EIF_TEST(loc1)) {
				tr1 = F708_6589(RTCV(arg1));
				loc2 = tr1;
				tb1 = EIF_TEST(loc2);
			}
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O4154[dtype-243])) {
						tc1 = F708_6583(Current);
						tc2 = F708_6583(RTCV(arg1));
				...
				F708_6614(RTCV(arg1), loc2);
			} else {
			}
		} else {
			tb2 = '\0';
			tb3 = '\0';
			if (F414_5127(Current)) {
				tb4 = F414_5127(RTCV(arg1));
				tb3 = tb4;
			}
			if (tb3) {
...
/* {LIST}.after */
EIF_BOOLEAN F622_5836 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F622_5837 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);

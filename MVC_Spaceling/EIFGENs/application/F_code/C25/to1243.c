...
/* {TO_SPECIAL}.area */
EIF_REFERENCE F659_6226 (EIF_REFERENCE Current)
{
...
void F659_6227 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	GTCX
...
void F659_6228 (EIF_REFERENCE Current, EIF_CHARACTER_8 arg1, EIF_INTEGER_32 arg2)
{
	GTCX
	EIF_REFERENCE tr1 = NULL;
	RTLD;
	...
	RTGC;
	tr1 = RTLNSP2(eif_non_attached_type(eif_final_id(Y5197,Y5197_gen_type,Dftype(Current),651)),0,arg2,sizeof(EIF_CHARACTER_8), EIF_TRUE);
	F762_6946(RTCV(tr1), arg1, arg2);
	RTAR(Current, tr1);
	*(EIF_REFERENCE *)(Current + O5197[Dtype(Current)-651]) = (EIF_REFERENCE) tr1;
	RTLE;
}
...
/* {TO_SPECIAL}.set_area */
void F659_6233 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX

...
/* {COLLECTION}.fill */
void F314_4517 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	for (;;) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R4201[dtype-404])(Current, (EIF_REFERENCE) &tu8_1);
		F709_6611(RTCV(loc1));
	}
	RTLE;
}
...
void F314_4519 (EIF_REFERENCE Current, EIF_NATURAL_64 arg1)
{
	GTCX
	RTCDT;
	RTLD;

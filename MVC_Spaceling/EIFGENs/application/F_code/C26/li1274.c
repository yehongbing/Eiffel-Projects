...
/* {LIST}.is_equal */
EIF_BOOLEAN F623_5835 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	if ((EIF_BOOLEAN)(Current == arg1)) {
		...
		Result = '\0';
		tb1 = '\0';
		tb2 = F415_5127(RTCV(arg1));
		if ((EIF_BOOLEAN)(F415_5127(Current) == tb2)) {
		...
		if (tb1) {
			...
			Result = (EIF_BOOLEAN)(F709_6600(Current) == ti4_1);
		}
		tb1 = '\0';
		if (Result) {
		...
		if (tb1) {
			tb1 = '\0';
			tr1 = F709_6589(Current);
			loc1 = tr1;
			if (EIF_TEST(loc1)) {
				tr1 = F709_6589(RTCV(arg1));
				loc2 = tr1;
				tb1 = EIF_TEST(loc2);
			}
			if (tb1) {
				...
				for (;;) {
					...
					if (*(EIF_BOOLEAN *)(Current + O4154[dtype-243])) {
						tu8_1 = F709_6583(Current);
						tu8_2 = F709_6583(RTCV(arg1));
...
/* {LIST}.after */
EIF_BOOLEAN F623_5836 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
...
/* {LIST}.before */
EIF_BOOLEAN F623_5837 (EIF_REFERENCE Current)
{
	GTCX
	EIF_INTEGER_32 ti4_1;
	EIF_BOOLEAN Result = ((EIF_BOOLEAN) 0);

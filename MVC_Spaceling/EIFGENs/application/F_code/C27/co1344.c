...
/* {COLLECTION}.fill */
void F316_4517 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	for (;;) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R4201[dtype-404])(Current, (EIF_REFERENCE) &tu2_1);
		F711_6611(RTCV(loc1));
	}
	RTLE;
}
...
void F316_4519 (EIF_REFERENCE Current, EIF_NATURAL_16 arg1)
{
	GTCX
	RTCDT;
	RTLD;

...
EIF_BOOLEAN F551_5688 (EIF_REFERENCE Current)
{
	GTCX
	...
	if (*(EIF_BOOLEAN *)(Current+ _CHROFF_2_0_)) {
		RTLE;
		return (EIF_BOOLEAN) F539_5671(Current);
	} else {
		Result = '\01';
...
void F551_5690 (EIF_REFERENCE Current)
{
	GTCX
...
EIF_REFERENCE F551_5691 (EIF_REFERENCE Current)
{
...
EIF_REFERENCE F551_5692 (EIF_REFERENCE Current)
{

...
/* {COLLECTION}.fill */
void F317_4517 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	for (;;) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R4201[dtype-404])(Current, (EIF_REFERENCE) &tr4_1);
		F713_6611(RTCV(loc1));
	}
	RTLE;
}
...
void F317_4519 (EIF_REFERENCE Current, EIF_REAL_32 arg1)
{
	GTCX
	RTCDT;
	RTLD;

...
/* {COLLECTION}.fill */
void F318_4517 (EIF_REFERENCE Current, EIF_REFERENCE arg1)
{
	GTCX
	...
	for (;;) {
		...
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_REFERENCE)) R4201[dtype-404])(Current, (EIF_REFERENCE) &ti8_1);
		F714_6611(RTCV(loc1));
	}
	RTLE;
}
...
void F318_4519 (EIF_REFERENCE Current, EIF_INTEGER_64 arg1)
{
	GTCX
	RTCDT;
	RTLD;

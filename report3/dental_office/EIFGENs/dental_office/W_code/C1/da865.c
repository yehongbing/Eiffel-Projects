...
extern EIF_TYPED_VALUE F865_7083(EIF_REFERENCE);
extern EIF_TYPED_VALUE F865_7084(EIF_REFERENCE);
extern EIF_TYPED_VALUE F865_7085(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F865_7078,12684,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 864, Current, 0, 0, 12685);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(864, Current, 12685);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000FB, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 864, Current, 0, 0, 12686);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(864, Current, 12686);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000FB, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 864, Current, 0, 0, 12687);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(864, Current, 12687);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000FB, 0,0); /* Result */
...
EIF_TYPED_VALUE F865_7083 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F865_7083,12689,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F865_7084 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F865_7084,12690,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F865_7085 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F865_7085,12691,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit865 (void)
{
	GTCX
	RTOTS (7078,F865_7078)
	RTOTS (7079,F865_7079)
	RTOTS (7080,F865_7080)
	RTOTS (7081,F865_7081)
	RTOTS (7082,F865_7082)
	RTOTS (7083,F865_7083)
	RTOTS (7084,F865_7084)
	RTOTS (7085,F865_7085)
}

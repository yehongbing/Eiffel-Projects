...
extern EIF_TYPED_VALUE F873_7160(EIF_REFERENCE);
extern EIF_TYPED_VALUE F873_7161(EIF_REFERENCE);
extern EIF_TYPED_VALUE F873_7162(EIF_REFERENCE);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 872, Current, 0, 0, 12707);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;

...
extern EIF_TYPED_VALUE F922_2255(EIF_REFERENCE);
extern EIF_TYPED_VALUE F922_2256(EIF_REFERENCE);
extern void F922_2257(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_2258(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_2259(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_2260(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F922_2261(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {SEQUENCE}.readable */
EIF_TYPED_VALUE F922_2255 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 921, Current, 0, 0, 13173);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(921, Current, 13173);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {SEQUENCE}.writable */
EIF_TYPED_VALUE F922_2256 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 921, Current, 0, 0, 13174);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(921, Current, 13174);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
...
/* {SEQUENCE}.force */
void F922_2257 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 921, Current, 0, 1, 13175);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 13175);
	RTCC(earg1, 921, l_feature_name, 1, RTWCT(1737, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
...
/* {SEQUENCE}.append */
void F922_2258 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 921, Current, 1, 1, 13176);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 13176);
	if (arg1) {
		{
...
/* {SEQUENCE}.put */
void F922_2259 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 921, Current, 0, 1, 13177);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 13177);
	RTCC(earg1, 921, l_feature_name, 1, RTWCT(1737, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune */
void F922_2260 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 921, Current, 0, 1, 13178);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 13178);
	RTCC(earg1, 921, l_feature_name, 1, RTWCT(1737, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
/* {SEQUENCE}.prune_all */
void F922_2261 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 921, Current, 0, 1, 13179);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(921, Current, 13179);
	RTCC(earg1, 921, l_feature_name, 1, RTWCT(1737, dtype, Dftype(Current)));
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);

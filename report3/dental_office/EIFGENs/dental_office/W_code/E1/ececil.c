...
EIF_TYPED_VALUE _A896_42_2 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE, EIF_TYPED_VALUE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5376, "has_root_canal", closed [1].it_r))(closed [1].it_r, open [1]);
}

	/* DENTAL_OFFICE has_root_canal */
EIF_TYPED_VALUE _A892_38_2 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE, EIF_TYPED_VALUE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5380, "has_root_canal", closed [1].it_r))(closed [1].it_r, open [1]);
}

	/* TOOTH is_root_canal */
EIF_TYPED_VALUE _A893_46_2 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE, EIF_TYPED_VALUE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5403, "is_root_canal", closed [1].it_r))(closed [1].it_r, open [1]);
}

	/* reference TOOTH is_root_canal */
EIF_TYPED_VALUE _A894_46_2 (EIF_TYPED_VALUE(*f_ptr) (EIF_REFERENCE, EIF_TYPED_VALUE) , EIF_TYPED_VALUE * closed, EIF_TYPED_VALUE * open)
{
	GTCX
	return (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(5403, "is_root_canal", closed [1].it_r))(closed [1].it_r, open [1]);
}

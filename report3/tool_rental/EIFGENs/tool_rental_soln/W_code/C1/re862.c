...
extern EIF_TYPED_VALUE F862_7051(EIF_REFERENCE);
extern EIF_TYPED_VALUE F862_7052(EIF_REFERENCE);
extern EIF_TYPED_VALUE F862_7053(EIF_REFERENCE);
extern EIF_TYPED_VALUE F862_7054(EIF_REFERENCE);
extern void F862_7055(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F862_7579(EIF_REFERENCE, int);
...
/* {REPAIR_DESC}.start_date */
EIF_TYPED_VALUE F862_7051 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {REPAIR_DESC}.end_date */
EIF_TYPED_VALUE F862_7052 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {REPAIR_DESC}.problem */
EIF_TYPED_VALUE F862_7053 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {REPAIR_DESC}.resolution */
EIF_TYPED_VALUE F862_7054 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
/* {REPAIR_DESC}.new_desc */
void F862_7055 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 861, Current, 0, 3, 12624);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 861, l_feature_name, 1, 863);
	}
	if (arg2) {
		RTCC(arg2, 861, l_feature_name, 2, 220);
	}
	if (arg3) {
		RTCC(arg3, 861, l_feature_name, 3, 890);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = '\0';
		if ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 != NULL) && (EIF_BOOLEAN)(arg2 != NULL)) && (EIF_BOOLEAN)(arg3 != NULL))) {
			...
			RTNHOOK(1,1);
			tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(4954, "bought", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(arg3);
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(1333, "is_less", tr2))(tr2, ur1x)).it_b);
			tb1 = tb2;
		}
		RTTE(tb1, label_1);
		RTCK;
...
/* {REPAIR_DESC}._invariant */
void F862_7579 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 861, Current, 0, 7578);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("dates_reasonable", Current);
	tb1 = '\01';

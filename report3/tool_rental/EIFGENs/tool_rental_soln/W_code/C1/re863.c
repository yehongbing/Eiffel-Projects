...
extern void F863_7073(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F863_7586(EIF_REFERENCE, int);
...
void F863_7073 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 862, Current, 0, 3, 12686);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 862, l_feature_name, 1, eif_new_type(864, 0x00), 0x00);
	}
	if (arg2) {
		RTCC(arg2, 862, l_feature_name, 2, eif_new_type(221, 0x00), 0x00);
	}
	if (arg3) {
		RTCC(arg3, 862, l_feature_name, 3, eif_new_type(891, 0x00), 0x00);
	}
	RTIV(Current, RTAL);
...
void F863_7586 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 862, Current, 0, 7585);
	RTSA(dtype);
	RTME(dtype, 0);

...
extern void F863_7061(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F863_7580(EIF_REFERENCE, int);
...
/* {RENTAL_DESC}.new_desc */
void F863_7061 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x, EIF_TYPED_VALUE arg4x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 862, Current, 0, 4, 12631);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(862, Current, 12631);
	if (arg1) {
		RTCC(arg1, 862, l_feature_name, 1, 863);
	}
	if (arg2) {
		RTCC(arg2, 862, l_feature_name, 2, 220);
	}
	if (arg3) {
		RTCC(arg3, 862, l_feature_name, 3, 220);
	}
	if (arg4) {
		RTCC(arg4, 862, l_feature_name, 4, 890);
	}
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = '\0';
		if ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN) ((EIF_BOOLEAN)(arg1 != NULL) && (EIF_BOOLEAN)(arg2 != NULL)) && (EIF_BOOLEAN)(arg3 != NULL)) && (EIF_BOOLEAN)(arg4 != NULL))) {
...
body:;
	if (RTAL & CK_ENSURE) {
		...
		ur1 = RTCCL(tr1);
		ur2 = RTCCL(arg2);
		tb4 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(16, dtype))(Current, ur1x, ur2x)).it_b);
		if (tb4) {
...
/* {RENTAL_DESC}._invariant */
void F863_7580 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 862, Current, 0, 7579);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	if ((EIF_BOOLEAN)(tr1 != NULL)) {
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4948, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4949, dtype))(Current)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
		ur1 = RTCCL(tr2);

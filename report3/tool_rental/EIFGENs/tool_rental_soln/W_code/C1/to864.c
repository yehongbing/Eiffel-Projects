...
extern void F864_7065(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F864_7581(EIF_REFERENCE, int);
...
/* {TOOL_DESC}.new_desc */
void F864_7065 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 863, Current, 0, 2, 12636);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg2) {
		RTCC(arg2, 863, l_feature_name, 2, 890);
	}
	RTIV(Current, RTAL);

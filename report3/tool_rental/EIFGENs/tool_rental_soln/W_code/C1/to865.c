...
extern void F865_7065(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F865_7579(EIF_REFERENCE, int);
...
/* {TOOL_DESC}.new_desc */
void F865_7065 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 864, Current, 0, 2, 12659);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if (arg1) {
		RTCC(arg1, 864, l_feature_name, 1, 220);
	}
	if (arg2) {
		RTCC(arg2, 864, l_feature_name, 2, 890);
	}
	RTIV(Current, RTAL);
...
void F865_7579 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 864, Current, 0, 7578);
	RTSA(dtype);
	RTME(dtype, 0);
